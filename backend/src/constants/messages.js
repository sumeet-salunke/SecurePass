export const AUTH_MESSAGES = Object.freeze({
  ...
  OTP_RESEND_COOLDOWN: "If account exists,an OTP is sent to your existing email and, ",
  ...
  MFA_ALEADY_ENABLED: "MFA Already enabled.",
  MFA_SETUU_READY: "MFA setup is ready.",

  MFA_CODE_REQUIRED: "MFA code is required. ",

  MFA_SETUP_REQUIRED: "MFA setup is required. ",
